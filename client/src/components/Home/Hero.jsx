...
const Hero = () => {
  ...
  return (
    <>
      <section className='w-full bg-[url("lucky_logo")]  bg-cover bg-center bg-no-repeat px-4 pb-10'>
        <nav className="flex items-center justify-between  w-full md:px-16 lg:px-24 xl:px-32 py-4">
          <a href="#" aria-label="CarrierHUb UI Logo">
            ...
            {/* <img src="lucky_logo" alt="CarrierHub" /> */}
            <div className="flex  ">
              <Aperture size={45} />
              <h3 className="flex flex-col items-center pt-2 font-semibold ">CareerHub</h3>
            </div>
          </a>

          {/* MENU LINKS */}
          <div
            className={`max-md:fixed max-md:inset-0 max-md:bg-white/50 max-md:overflow-hidden max-md:transition-[width] max-md:duration-300 max-md:top-0 max-md:left-0 max-md:flex-col max-md:justify-center max-md:text-lg max-md:backdrop-blur flex items-center gap-8 ${menuOpen ? "max-md:w-full" : "max-md:w-0"}`}
          >
            <a className="text-sm text-neutral-800" href="#">
              Home
            </a>
            <a className="text-sm text-neutral-800" href="#">
              Products
            ...
            <button class="md:hidden px-6 py-2.5 bg-[#4F39F6] hover:bg-[#3e2fcc] active:scale-95 rounded-full text-white text-sm">
              Explore Features
            </button>
            <button
          ...
          <button className="max-md:hidden px-6 py-2.5 bg-[#4F39F6] hover:bg-[#3e2fcc] active:scale-95 rounded-full text-white text-sm cursor-pointer">
            Explore Features
          </button>
        ...
        <div className="w-full md:px-16 lg:px-24 xl:px-32 mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-8 py-20">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-center lg:text-left text-base/7 text-neutral-600 max-w-md mt-4 mx-auto md:mx-0">
              Prepare smarter, faster, and together. Practice DSA, build
              industry-ready resumes, and train for real interviews — all from
              one platform.
            </p>
            ...
            <div className="flex items-center mt-10 mx-auto lg:mx-0">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-600">
                  Built for students, developers, and future software engineers.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full max-w-md md:max-w-lg">
            <img
              ...
              src={
                "https://assets.prebuiltui.com/images/components/hero-section/hero-rightsocial-image.png"
              }
